...
# RUN /bin/sh -c wget http://xdebug.org/files/xdebug-2.8.0.tgz &&     tar -xvzf xdebug-2.8.0.tgz &&     cd xdebug-2.8.0 &&     phpize &&     ./configure &&     make &&     cp modules/xdebug.so /usr/lib/php7/modules # buildkit
